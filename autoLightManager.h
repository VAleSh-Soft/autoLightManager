...
#define BTN_ALM2_PIN 6      // пин кнопки включения второго режима автосвета
#define BTN_ALM3_PIN 5      // пин кнопки включения третьего режима автосвета
#define BTN_CLOCK_SET_PIN 8 // пин кнопки включения режима настройки часов
#define BTN_CLOCK_UP_PIN 9  // пин кнопки смены значений в режиме настройки
